...
<body>
            ...
            <div class="container">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb py-3">
                      ...
                      <li class="breadcrumb-item" aria-current="page">Bottom Wear's</li>
                    </ol>
                </nav>
            </div>
        </section>
        ...
        <section class="options container py-5">
            <div class="d-flex align-item-center justify-content-center">
                <div class="btn-group btn-group-sm " role="group" aria-label="Basic outlined example">
                    <button type="button" onclick="BottomSelect('jeans')" class="btn btn-outline-primary Buttons">Jeans</button>
                    <button type="button" onclick="BottomSelect('formals')" class="btn btn-outline-primary Buttons">Formals</button>
                    <button type="button" onclick="BottomSelect('tracks')" class="btn btn-outline-primary Buttons">Tracks</button>
                    <button type="button" onclick="BottomSelect('shorts')" class="btn btn-outline-primary Buttons">Shorts</button>
                </div>
            </div>
        </section>
        <section class="container-fluid">
            <div class="row" id="shirtSection">
                <h2 class="pb-4">Men's Jeans</h2>
                <%
            	...
            	try{
                	...
                	ResultSet rs = st.executeQuery("SELECT * FROM products where catogary = 'jeans'");
                	while(rs.next()){
                		int id = rs.getInt("id");
                ...
                <div class="col-6 col-md-4 col-lg-3">
                	<div class="w-100 py-3 shirt-card">
                		<img class="img-fluid" src="./images/illustration/jeans/<%=image %>" alt="<%=image %>">
                ...
                <%	
                		...
                		if(request.getParameter("shopnow")!=null){
                			...
                			response.sendRedirect("BottomWearDetailPage.jsp");
                		}
                	}
                }catch(Exception e){
                	e.getMessage();
            ...
            <div class="row d-none" id="tshirtSection">
                <h2 class="pb-4">Men's Formals</h2>
                <%
                try{
            		Class.forName("com.mysql.cj.jdbc.Driver");
                	con = DriverManager.getConnection(path, username, SqlPassword);
                	st = con.createStatement();
                	ResultSet rs = st.executeQuery("SELECT * FROM products where catogary = 'formals'");
                	while(rs.next()){
                		int id = rs.getInt("id");
                		String imageNames = rs.getString("pImg");
                		int comma = imageNames.indexOf(",");
                ...
                <div class="col-6 col-md-4 col-lg-3">
                	<div class="w-100 py-3 shirt-card">
                		<img class="img-fluid" src="./images/illustration/formals/<%=image %>" alt="<%=image %>">
                		<div class="text-center product-detail">
                			<p class="py-3 mb-0"><%=name %></p>
                			<Span class="fs-4">&#8377; <%=prize %></Span>
                			<form action="#" method="post">
            ...
            <div class="row d-none" id="hoodieSection">
                <h2 class="pb-4">Men's Tracks Pants</h2>
                <%
                try{
            		Class.forName("com.mysql.cj.jdbc.Driver");
                	con = DriverManager.getConnection(path, username, SqlPassword);
                	st = con.createStatement();
                	ResultSet rs = st.executeQuery("SELECT * FROM products where catogary = 'tracks'");
                	while(rs.next()){
                		int id = rs.getInt("id");
                		String imageNames = rs.getString("pImg");
                		int comma = imageNames.indexOf(",");
                ...
                <div class="col-6 col-md-4 col-lg-3">
                	<div class="w-100 py-3 shirt-card">
                		<img class="img-fluid" src="./images/illustration/tracks/<%=image %>" alt="<%=image %>">
                		<div class="text-center product-detail">
                			<p class="py-3 mb-0"><%=name %></p>
                			<Span class="fs-4">&#8377; <%=prize %></Span>
                			<form action="#" method="post">
            ...
            <div class="row d-none" id="jacketSection">
                <h2 class="pb-4">Men's Shorts</h2>
                <%
                try{
            		Class.forName("com.mysql.cj.jdbc.Driver");
                	con = DriverManager.getConnection(path, username, SqlPassword);
                	st = con.createStatement();
                	ResultSet rs = st.executeQuery("SELECT * FROM products where catogary = 'shorts'");
                	while(rs.next()){
                		int id = rs.getInt("id");
                		String imageNames = rs.getString("pImg");
                		int comma = imageNames.indexOf(",");
                ...
                <div class="col-6 col-md-4 col-lg-3">
                	<div class="w-100 py-3 shirt-card">
                		<img class="img-fluid" src="./images/illustration/shorts/<%=image %>" alt="<%=image %>">
                		<div class="text-center product-detail">
                			<p class="py-3 mb-0"><%=name %></p>
                			<Span class="fs-4">&#8377; <%=prize %></Span>
                			<form action="#" method="post">
    ...
    <script src="./js/BottomWearPage.js"></script>    
</body>
</html>