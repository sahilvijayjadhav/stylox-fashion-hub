...
<body>
	...
	try {
		...
		if (rs.next()) {
			...
			String image = rs.getString("pImg"); //img1,img2,img3
			String[] imagesName = image.split(",");//[img1,imh]
			...
			<div class="container">
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb py-3">
						<li class="breadcrumb-item"><a href="./BottomWearPage.jsp">Bottom Wear</a></li>
							...
							%>
								...
								<div class="form-check">
									<input class="form-check-input" type="radio"
										name="selectedColors" id="<%=colorArray[i]%>" value="<%=colorArray[i]%>" required> <label
